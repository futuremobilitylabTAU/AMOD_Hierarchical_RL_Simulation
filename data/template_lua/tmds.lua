...
local beta_cons_walk = 2.8 +0.5 -0.2 -0.1
local beta_cons_bike = -2 -2    +1
local beta_cons_drive1 =  0  +2 -1 -0.5 +0.2 +0.2 +0.1 +0.05 -0.01 +0.01 +0.01 -0.01 +0.01 +1 -1.2  -0.5 +0.2  +1 -0.7            
local beta_cons_share2 = 0 +1 -0.5 -0.5+0.1 -0.02                           
local beta_cons_share3 = 0 +0.5 -0.1 -0.1                              
local beta_cons_PT = 0  +2 -0.5 +0.1 +0.1 +0.01 +0.02    -0.5 +0.1 -0.1                       
local beta_cons_PB = 0                                   
local beta_cons_motor = 0 +2 +2 +1  -1 -1 -1   -0.5                         
local beta_cons_taxi = -2 -3 +1  +1                 
local beta_cons_SMS = 0                                    
local beta_cons_MRT = 0  +2 -0.5 +0.1 +0.1 +0.01 +0.02    -0.5 +0.1 -0.1                                    
...
local beta_tt_motor = -0.170
local beta_tt_taxi = -0.0213
local beta_tt_SMS = -0.0213
local beta_tt_MRT = -0.0556
...
local beta_cbd_drive1 = -1.82    +2  
local beta_cbd_share2 = -1.19    +2  
local beta_cbd_share3 = -0.713   +2  
local beta_cbd_PT = 1.21         +2 -1 -1
local beta_cbd_notdrive = 0.859  +2  -1
...
local beta_Boston = (beta_cbd_drive1 + beta_cbd_share2 + beta_cbd_share3)/3*3.5
local beta_cost = -0.171
--choice set
...
local function computeUtilities(params,dbparams)
	...
	for i =1,917 do
		...
		tt_AMOD_Pool[i]= tt_AMOD[i] * 1.35 + 5/60
	...
	for i =1,917 do
		...
		exp(beta_population)*population[i]+exp(beta_shop)*shop[i])
