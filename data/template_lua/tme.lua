...
local cons_SMS = 0  
local cons_MRT = 0                                
local cons_AMOD = cons_taxi
local cons_AMOD_Pool = cons_taxi +beta_cost*0.65
...
local beta_central_AMOD = beta_central_PT
local beta_central_AMOD_Pool= beta_central_PT
...
local beta_LIC_AMOD = 0
local beta_LIC_AMOD_Pool = 0
...
--	beta_undergraduate_SMS * undergraduate  
	...
	beta_cost * cost_AMOD + beta_central_AMOD * CBD + 
	beta_female_taxi * female +
	beta_TRANS_AMOD * TRANS + beta_LIC_AMOD * LIC +beta_zerocar_AMOD * zerocar +
	...
	beta_cost * cost_AMOD_Pool + beta_central_AMOD_Pool * CBD +
	beta_female_taxi * female +
	beta_TRANS_AMOD_Pool * TRANS + beta_LIC_AMOD_Pool * LIC +beta_zerocar_AMOD_Pool * zerocar +
